...
class HierarchicalStateMemory:
    ...
    def update(self, state_hash: str, url: str, dom_text: str, 
        ...
        old_q = mem["q"]
        mem["avg_reward"] = mem["avg_reward"] + (reward - mem["avg_reward"]) / mem["count"]
    ...
    def get_stats(self) -> Dict[str, Any]:
        return {
            ...
            "avg_q_value": np.mean([m["q"] for m in self.semantic_memory.values()]) if self.semantic_memory else 0.0,
        }
